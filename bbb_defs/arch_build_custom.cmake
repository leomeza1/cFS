...
#
add_compile_options(
#    -std=c99                # Target the C99 standard (without gcc extensions) - having trouble with RTEMS network 
                            # It seems that using this options removes access to gethostbyname and SO_DONTWAIT
...
#    -Wno-error=stringop-truncation   # Optimizing with GCC 10 causes this in ES - only on Microblaze?
    -Wno-error=format-truncation     # Optimizing with GCC 10 causes this in utassert 
    -Wno-error=restrict     # Optimizing with GCC 10 causes this in rtems OSAL (impl-filesys) 
)
